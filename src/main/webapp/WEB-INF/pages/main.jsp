            ...
            <div class="col-md-7 box" style="border: 1px solid #000;">
                ...
                <div class="media news">
                    ...
                    <div class="media-body">
                        <p class="media-heading">
                            <span class="person">Jan Kowalski</span>
                            Dodał komentarz do spaceru <a href="#" class="event"> Zwiedzanie Rynku </a>
                        </p>
                        <blockquote>
                            Bardzo udany spacer, piękne okolice i widoki.
                        </blockquote>
                    </div>
                </div>
                ...
                <div class="media news">
                    ...
                    <div class="media-body">
                        <p class="media-heading">
                            <span class="person">Adam Nowak</span>
                            Stworzył ogłoszenie <a href="/AnnounceTest" class="event"> Stare Miasto - Zwiedzanie </a>
                        </p>
                        <blockquote>
                            Data: 18.05.2017<br>
