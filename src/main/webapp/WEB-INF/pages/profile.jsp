        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-2 box text-center">
                    ...
                    <div class="row">
                        <a href="/Profile-edit">  
                            <span class="glyphicon glyphicon-cog"></span> Zmień dane
                        </a>
                    </div>
                ...
                <div class="col-md-7 box" style="border: 1px solid #000;">
                    ...
                    <div class="tab-content">
                        <div id="info" class="tab-pane fade in active">
                            <h3>O mnie</h3>
                            <p>Lubię spokojne spacerki, głównie w łonie natury.</p>
                            <p>Nie lubię przebywać w towarzystwie osób palących.</p>
                        </div>
                        <div id="photo" class="tab-pane fade">
                            <h3>Zdjęcia</h3>
                            <p>Użytkownik nie posiada żadnych zdjęć</p>
                        </div>
                        <div id="event" class="tab-pane fade">
                            
                            <div class="row">
                                <div class="col col-md-6">
                                   <p> Wystawione ogłoszenia </p>
